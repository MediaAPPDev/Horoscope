...
-(void)defaultInit{
    ...
    [_button setImage:[UIImage imageNamed:@"weixuanzhong"] forState:UIControlStateNormal];
    [_button setImage:[UIImage imageNamed:@"xuanzhong"] forState:UIControlStateSelected];
